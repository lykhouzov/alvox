...
pub struct Light {
    ...
    pub uniform: crate::LightUniform,
...
impl Light {
    pub fn new(engine: &utils::Engine) -> Light {
        ...
        let mut light_uniform = crate::LightUniform::new(10.0, [1.0, 1.0, 1.0]);
        ...
        let light_controller = light::LightController::new(1.0, 1.0);
        Light {
            model: light_model,
